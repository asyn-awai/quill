    ...
    return (
        <>
            <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center">
                ...
                >
                    Get Started <ArrowRight className="ml-2" size={25} />
                </Link>
            </MaxWidthWrapper>
            <section>
                <div className="relative isolate">
                    ...
                    >
                        <div
                            ...
                            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] -z-10"
                        />
                    </div>
                    {/* <div> */}
                    ...
                    >
                        <div
                            ...
                            className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem] -z-10"
                        />
                    </div>
                </div>
            </section>
                ...
                <ol className="my-8 mx-4 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
                    <li className="md:flex-1">
                        <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                            ...
                            <span className="mt-2 text-zinc-700">
                                Either start out with a free plan or try out our{" "}
                                <Link
                                    href="/pricing"
                                    className={buttonVariants({
                                        variant: "link",
                    ...
                    <li className="md:flex-1">
                        <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                            ...
                            <span className="mt-2 text-zinc-700">
                                It&apos;s really that simple. Try out quill
                                today!
                            </span>
                        </div>
                    </li>
